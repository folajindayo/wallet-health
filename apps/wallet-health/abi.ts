/**
 * GaslessAchievements Smart Contract ABI
 * 
 * NFT contract for game achievements with gasless claiming via EIP-2771 meta-transactions
 * Players can claim achievement NFTs without paying gas fees using a trusted relayer
 * 
...
export const GASLESS_ACHIEVEMENTS_ABI = [
    ...
    "inputs": [
      {
        ...
        "type": "uint8",
        "indexed": true,
        "internalType": "enum GaslessAchievements.AchievementType"
      },
      {
        "name": "name",
        "type": "string",
      ...
      },
      {
        ...
        "type": "uint8",
        "indexed": false,
        "internalType": "enum GaslessAchievements.Rarity"
      },
      {
        "name": "scoreRequired",
        "type": "uint256",
    ...
    "outputs": [
      {
        ...
        "internalType": "struct GaslessAchievements.Achievement"
      }
    ],
    "stateMutability": "view"
  },
  ...
  },
  {
    ...
    "outputs": [
      ...
      {
        "name": "obstaclesDodged",
        "type": "uint256",
        "internalType": "uint256"
      },
      {
        "name": "multiplayerWins",
        "type": "uint256",
        "internalType": "uint256"
      },
      {
  ...
  {
    "name": "setGameRewardsContract",
    "type": "function",
    "inputs": [
      {
        "name": "_gameRewardsContract",
        "type": "address",
        "internalType": "address"
      }
    ],
